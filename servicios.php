...
<head>
  <title>Servicios que ofrecemos | Real Yacht Rental</title>
...
<body>
  ...
  ?>
    ...
    <section class="llamamos">
      ...
      <form action="mail/mailtelf-servicios.php" method="post">
        <p>
    ...
    <section class="contacto-index">
      ...
      <form action="mail/mail-servicios.php" method="post">
        <p>
